...
export const courses: readonly CourseDefinition[] = [
  {
    ...
    title: "從財商覺醒，到時間自由",
    summary:
      "亞洲第一企業家教練 Yesir 鄭凱名博士與 Forbes 福布斯 ESG 企業家・亞洲富爸爸 James Sir 合作打造，將賺錢、理財、投資、借貸、生活成本、AI 微創業及被動收入，整合成一套屬於你的時間自由系統。",
    price: 980,
    referralPrice: 880,
    ...
    lessons: [
      {
        ...
        items: [
          "【穩・流・爆・快】從起步到收入自由的基礎",
          "拆解較穩健財技工具的風險、限制與適用情境",
          "理解時間自由為何可能比想像中更接近",
          "以每月 HK$30,000 為目標，建立可計算的被動收入方向",
          "經營心態、投資心理與決策習慣",
        ],
      },
      {
      ...
      {
        title: "把 HK$30,000 目標拆解成可行的路線",
        focus: "Lesson 3 · AI 微創業、旅居與五種金錢能力",
        items: [
          "認識 AI 微創業與無國界藍海市場",
          "填寫你的優悠白書，認識不同國家的旅居方式",
